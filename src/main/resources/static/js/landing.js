    ...
    return html`
      <nav class="lp-nav">
        <div class="lp-nav-left">
          <a href="/" class="lp-brand"><span class="lp-mark" aria-hidden="true"><img src="/img/logo-mark.png" alt="" onError=${(e) => e.currentTarget.remove()} /></span>InsightOn</a>
  ...
  function Footer() {
    return html`
      <footer class="lp-footer">
        <span class="lp-brand"><span class="lp-mark" aria-hidden="true"><img src="/img/logo-mark.png" alt="" onError=${(e) => e.currentTarget.remove()} /></span>InsightOn</span>
