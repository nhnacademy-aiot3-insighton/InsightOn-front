    ...
    return html`
      <nav class="lp-nav">
        <div class="lp-nav-left">
          <a href="/" class="lp-brand"><span class="lp-mark" aria-hidden="true"><img src="/img/logo-mark.svg" alt="" onerror="if(this.dataset.step==null){this.dataset.step='1';this.src='/img/logo-mark.png';}else if(this.dataset.step=='1'){this.dataset.step='2';this.src='/img/logo-mark.jpg';}else{this.remove();}" /></span>InsightOn</a>
  ...
  function Footer() {
    return html`
      <footer class="lp-footer">
        <span class="lp-brand"><span class="lp-mark" aria-hidden="true"><img src="/img/logo-mark.svg" alt="" onerror="if(this.dataset.step==null){this.dataset.step='1';this.src='/img/logo-mark.png';}else if(this.dataset.step=='1'){this.dataset.step='2';this.src='/img/logo-mark.jpg';}else{this.remove();}" /></span>InsightOn</span>
